...
-(void)setupPipeline
{
    ...
    id<MTLFunction> vertexFunction = [defaultLibrary newFunctionWithName:@"vertexAGShader"];
    id<MTLFunction> fragmentFunction = [defaultLibrary newFunctionWithName:@"fragmentAGShader"];
...
- (void)drawInMTKView:(MTKView *)view {
    ...
    if(renderPassDescriptor != nil)
    {
        ...
        [renderEncoder setVertexBytes:&_viewportSize
                              ...
                              atIndex:AGVertexInputIndexViewportSize];
        
        [renderEncoder setVertexBuffer:_vertices
                                offset:0
                               atIndex:AGVertexInputIndexVertices];
        
        [renderEncoder setFragmentBuffer:_vertexPoint
                                  offset:0
                                 atIndex:AGFragmentInputIndexVertexPoint];
        
        [renderEncoder setFragmentBytes:&_viewportSize
                                 length:sizeof(_viewportSize)
                                atIndex:AGFragmentInputIndexViewportSize];
